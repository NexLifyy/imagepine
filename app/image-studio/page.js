...
export default function StudioPage() {
  ...
  const faqs = [
    {
      q: "What can I do with Image Studio?",
      a: "Image Studio is an all-in-one browser editor that lets you resize images by exact pixels or percentage, reduce file size with adjustable compression quality, rotate by 90° or custom angles, flip horizontally and vertically, copy edited photos directly to your clipboard, and inspect changes using a live split-screen comparison slider."
    },
    {
      q: "How does the live Before/After comparison slider work?",
      a: "When you upload and edit a picture in Image Studio, a dynamic interactive slider appears over your image canvas. Simply drag the slider handle left and right to instantly compare the original high-resolution photo with your edited result in real time."
    },
    {
      q: "Can I copy the edited image to my clipboard without downloading?",
      a: "Yes! Beside the green 'Download' button, click 'Copy Image' to copy your compressed and edited image straight to your computer's clipboard. You can then immediately paste (Ctrl+V) it into Discord, Slack, WhatsApp, Figma, Canva, or Google Docs without cluttering your Downloads folder."
    },
    {
      q: "Can I apply resizing, rotating, flipping, and compression all in one step?",
      a: "Yes. All adjustments you configure — dimensions, rotation angle, flip direction, and compression quality — are processed simultaneously in a single operation when you click 'Apply & Download' or 'Copy Image'."
    },
    {
      q: "What image file formats are supported?",
      a: "You can upload JPEG, PNG, WebP, and SVG files. You can export your final result as high-quality JPG, PNG (with transparent backgrounds preserved), or WebP."
    },
    {
      q: "Are my photos uploaded to any remote server?",
      a: "No, never. All image processing runs 100% locally inside your browser sandbox. Your images and personal files never leave your device."
    }
  ];
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "WebApplication",
                "name": "Image Studio - ImagePine",
                "url": "https://www.imagepine.com/image-studio",
                "applicationCategory": "MultimediaApplication",
                "operatingSystem": "All",
                "browserRequirements": "Requires JavaScript. Requires HTML5.",
                "description": "All-in-one browser image studio. Resize, compress, rotate, and flip photos with live before/after comparison. 100% private, no uploads.",
                "offers": {
                  "@type": "Offer",
                  "price": "0",
                  "priceCurrency": "USD"
      ...
      {!hasFiles && (
        <section style={{maxWidth:720,margin:'0 auto',padding:'80px 24px 60px',textAlign:'center'}} className="animate-fade-up">
          <h1 style={{fontSize:'clamp(34px,6vw,56px)',fontWeight:900,color:'#111128',lineHeight:1.08,letterSpacing:'-0.04em',margin:'0 0 16px'}}>
            Image Studio{' '}
            <span style={{background:'linear-gradient(135deg,#5B5BD6 0%,#7C3AED 100%)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent'}}>Online</span>
          </h1>
          <p style={{fontSize:'clamp(14px,2.5vw,18px)',color:'#6B6B8A',lineHeight:1.65,fontWeight:400,maxWidth:520,margin:'0 auto 44px'}}>
            All-in-one browser editor: resize, compress, rotate, and flip photos with live before/after comparison. 100% private in your browser.
          </p>
        ...
        <div style={{maxWidth:860,margin:'0 auto'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:16}}>
            {[
              ...
              {step:'03',title:'Download or Copy',desc:'Hit Apply & Download to save your image, or click Copy Image to paste directly into Discord, Slack, Canva, or Figma.'},
            ].map(({step,title,desc})=>(
